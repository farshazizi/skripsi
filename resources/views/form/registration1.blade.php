...
<div class="limiter">
    {{-- <div class="container-login100"> --}}
        <div class="login100-more-home" style="background-color: #be2a38; width: 100%; height: 100%">
        	<div class="container">
				<div class="row" style="padding-bottom: 3%; padding-top: 3%; ">
					<div class="col-md-6" style="background-color: white; margin-left: 27%; border-radius: 8px;">
						...
						{!! Form::open(['route' => 'registration.store']) !!}
						    ...
						    {{ Form::label('#', '*', array('style' => 'margin-top: 20px; color: red')) }}
						    {{ Form::number('penghasilan', null, array('id' => 'penghasilan', 'name' => 'penghasilan', 'class' => 'form-control', 'required' => '', 'min' => '0', 'placeholder' => 'Rata-rata penghasilan perbulan')) }}
						    ...
						    {{ Form::submit('Next', array('class' => 'btn btn-primary btn-md btn-block', 'style' => 'margin-top: 3%; margin-bottom: 5%; margin-left: 80%; width: 20%; right: 16px')) }}
