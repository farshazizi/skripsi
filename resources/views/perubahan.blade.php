	...
	<div class="row" style="margin-top: 0%; margin-bottom: 5%">
		<div class="col-md-6 col-md-offset-3">
			{!! Form::open(['route' => 'registration7.store']) !!}
				...
				{{ Form::select('penghasilan_calon_pasangan', ['' => 'Pilihan', 'Miskin' => '<= Rp4.000.000', 'Sedang' => 'Rp4.000.001 - Rp6.000.000', 'Kaya' => '=> Rp6.000.001'], null, array('class' => 'form-control', 'required' => '')) }}
