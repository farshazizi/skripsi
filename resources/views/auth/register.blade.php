        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" style="background-image: url('images/ok.png');">
            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    <label for="name" class="col-md-6 control-label" style="color: white">Nama Lengkap</label>
                ...
                <div class="form-group">
                    <label for="password-confirm" class="col-md-6 control-label" style="color: white">Confirm Password</label>
